...
export const clients = mysqlTable(
  "clients",
  {
    ...
    notes: text("notes"),
    suspendedReason: mysqlEnum("suspended_reason", ["admin", "payment_overdue"]),
    avatarUrl: varchar("avatar_url", { length: 500 }),
    createdAt: datetime("created_at", { mode: "date" }).notNull(),
    updatedAt: datetime("updated_at", { mode: "date" }).notNull(),
  },
...
export const subscriptions = mysqlTable(
  "subscriptions",
  {
    ...
    status: mysqlEnum("status", ["active", "past_due", "canceled", "trialing", "paused", "blocked"]).notNull().default("trialing"),
    ...
    gracePeriodUntil: datetime("grace_period_until", { mode: "date" }),
    paymentFailedAt: datetime("payment_failed_at", { mode: "date" }),
    failedPaymentCount: int("failed_payment_count").notNull().default(0),
    createdAt: datetime("created_at", { mode: "date" }).notNull(),
    updatedAt: datetime("updated_at", { mode: "date" }).notNull(),
  },
  (t) => ({
...
export const manualPayments = mysqlTable(
  "manual_payments",
  {
    ...
    paymentMethod: mysqlEnum("payment_method", ["cash", "bank_transfer", "cheque", "other", "card"]).notNull().default("other"),
